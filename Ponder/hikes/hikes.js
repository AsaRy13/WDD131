  ...
  document.getElementById("hike-container").innerHTML += `
    <div class="hike-card">
      <div class="hike-content">
        ...
        <p><span class="rating" role="img" aria-label="${hike.difficulty} out of 5">${makeDifficultyString(hike.difficulty)}</span></p>
      </div>
    </div>
  `;
}

function makeDifficultyString(difficulty){
...
/*
const people = [{name: "James", age: 33}, {name: "Bob", age: 40}, {name: "Josh", age: 29}];
console.log(people);
