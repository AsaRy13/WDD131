...
articles.forEach(article => {
    const card = `
        <article class="book-showcase">
            <hr class="divider">
            <p class="book-info">
                <span class="date"><i>${article.date}</i></span><br><br>
                <span class="age">${article.ages}</span><br><br>
                <span class="genre">${article.genre}</span><br><br>
                <span class="stars">${article.stars}</span><br><br>
            </p>
